<template>
  <div id="app">
    ...
    <p class="text">
      ...
      <a
        href="https://dif.org.ua/article/koruptsiya-u-povsyakdennomu-zhitti-ukraintsiv-za-shcho-daemo-khabari-komu-i-chomu345654"
      >Опитування</a> показують, що медицина була найбільш корумпованою сферою життя українців. Більшості з нас доводилося або давати гроші лікарю, або “неофіційно” платити за ліки, кращий догляд чи зручнішу палату.
    </p>

    <p
      class="text"
    >Система охорони здоров’я, яка склалася в незалежній Україні, виникла ще за Радянського Союзу. На початку ХХІ століття вона остаточно застаріла. Плани щодо її реформування передавалися від одного уряду до іншого. Всі розуміли, що це необхідно робити, але у жодного уряду не вистачало політичної волі, аби здійснити непопулярную реформу.</p>

    <p class="text">
      У 2014 році Міністерство охорони здоров’я, яке очолював Олександр Квіташвілі, створило
      <a
        href="http://uoz.cn.ua/strategiya.pdf"
      >стратегію</a> реформи системи охорони здоров’я до 2020 року. Пізніше міністерство очолила Уляна Супрун — саме вона стала головним лобістом реформи і зуміла її запустити.
    </p>

    <p
      class="text"
    >Як відбулася реформа? Спочатку МОЗ розділило лікарні залежно від їхньої спеціалізації на три рівні. На першому рівні — лікарні, які займаються профілактикою, діагностують і лікують прості хвороби. Там працюють лікарі загальної практики, тобто, сімейні лікарі і педіатри. Якщо пацієнт в складному стані, або якщо лікар на першому рівні не може визначити хворобу, він передає його спеціалісту.</p>

    <p
      class="text"
    >У лікарнях другого рівня працюють лікарі з конкретною спеціальністю: гастроентерологи, гінекологи, ендокринологи та інші. Вони працюють на складнішому обладнанні і можуть допомогти тоді, коли зусиль звичайного лікаря недостатньо. Нарешті, на третьому рівні — лікарні зі складним і дорогим обладнанням і найбільш кваліфікованими лікарями, часто це хірурги. Вони допомагають людям із найсерйознішими хворобами, з якими не змогли впоратися лікарі на нижчих рівнях.</p>

    <p
      class="text"
    >Для чого лікарні поділили на рівні? Для того, щоб почати платити напряму лікарям за реальні послуги, які вони надали. До початку реформи уряд переказував кошти для медицини місцевим бюджетам. Місцева влада розподіляла ці гроші між лікарнями на свій розсуд. В таких умовах у лікарень не було жодних стимулів розвиватися. Вони отримували гроші залежно від кількості працівників, лікарняних ліжок і жителів у районі. Якщо в одній лікарні за рік провели сто операцій, а в іншій одну — отримували вони однаково.</p>

    <p class="text">
      Медреформа запропонувала інший принцип: лікарня отримує гроші за реальну роботу — операції, аналізи, пацієнтів, яким допомогла. Гроші йдуть до лікарень напряму, і розподіляє їх
      <a
        href="https://www.kmu.gov.ua/ua/diyalnist/reformi/rozvitok-lyudskogo-kapitalu/reforma-sistemi-ohoroni-zdorovya"
      >Національна служба здоров’я України</a> (НСЗУ). Служба отримує гроші з державного бюджету і визначає, скільки потрібно платити за ті чи інші послуги. Вона з’явилася на початку 2018 року, а в липні вже почала платити лікарням першого рівня.
    </p>

    <p
      class="text"
    >За законом, перший рівень медичного обслуговування — безкоштовний. До 2020 року другий і третій рівень фінансуватимуться так само, як до реформи. За цей час НСЗУ повинна проаналізувати, за якими медичними послугами звертаються люди, яке обладнання та спеціалісти потрібні лікарням, і скільки все це коштуватиме. На основі своїх підрахунків служба затвердить тарифи — скільки коштує та чи інші медична процедура. Крім тарифів, НСЗУ визначить, за які процедури платить держава, а за які — самі пацієнти.</p>
    ...
    <p
      class="text"
    >Лікарям другого та третього рівня платитимуть вже за конкретні послуги, але НСЗУ ще тільки рахує, скільки вони повинні коштувати, і за які з них платитиме держава. Остаточні цифри мають з’явитися у 2020 році. Як рахують? Збирають і аналізують статистику про те, на що хворіють люди, до яких лікарів частіше звертаються, і які медичні процедури їм потрібні.</p>
    ...
    <p
      class="text"
    >В середині 2019 року майже завершився перший етап — реформа сімейних лікарів. За цей час у НСЗУ накопичилися такі дані:</p>
    <ul class="text">
    ...
    <p
      class="text"
    >Донедавна користувачі могли побачити ці дані лише у вигляді інтерактивних візуалізацій на сайті служби здоров’я, але не могли завантажити й працювати з ними у себе на комп’ютері.</p>

    <p
      class="text"
    >Тепер вони опубліковані у форматі відкритих даних на єдиному національному порталі. Відкриті дані — це публічна інформація в форматах, які дозволяють її автоматичну обробку. Доступ до цих даних та їх використання — вільні та безоплатні.</p>

    <p
      class="text"
    >В Україні відкриті дані на державному рівні почали підтримувати в 2015 році. Тоді Кабінет Міністрів України ухвалив Постанову №835, яка визначила, якими мають бути відкриті дані, встановила 300 обов’язкових до публікації наборів даних і вказала, хто їх публікуватиме й на яких умовах.</p>
    ...
    <p
      class="text"
    >Але найбільше і найрівномірніше зросли витрати на комп’ютери та електронні системи для лікарень, оскільки це вимога реформи. Міністерство охорони здоров’я вимагає від лікарень перевести в електронну форму більшість процесів: електронні кабінети лікарів, електронні картки пацієнтів, електронні рецепти та системи направлень. Тому лікарням необхідно закуповувати обладнання й комп’ютерні системи.</p>

    <p class="text">
      Таким чином, ми бачимо, що лікарні справді почали більше вкладати грошей у розвиток. Ви можете скористатися таблицею внизу, щоб самостійно перевірити, що купують лікарні.
      <b>Введіть в поле пошуку назву лікарні або товару, який вас цікавить. У таблиці є 100 найбільших закупівель у кожній категорії. Категорії бувають дуже різними, наприклад, медичне обладнання, послуги з будівництва, меблі, комп’ютерна техніка та інші</b>.
    </p>
