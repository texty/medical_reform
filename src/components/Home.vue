<template>
  <div>
    ...
    <div class="main" :style="{'margin-left': leftHeaderMargin, 'width': leftHeaderWidth, 'text-align':'left' }">
      ...
      <p class="text">Завдяки співпраці НСЗУ з Міністерством цифрової трансформації, дані щодо першого етапу медреформи відтепер стануть доступними кожному на веб-порталі <a href="https://data.gov.ua/organization/natsionalna-sluzhba-zdorovia-ukrainy">відкритих даних</a>. Завдяки цим даним і візуалізаціям на їхній основі ми можемо оцінити, як змінилась медицина від початку реформи.</p>
