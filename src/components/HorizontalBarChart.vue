...
<div>
  ...
  <div class="description"  :style="{ 'margin-left': leftHeaderMargin, 'margin-bottom': '50px','width': leftHeaderWidth }">
    ...
    <p class="text">Більшість людей підписали декларацію зі своїм сімейним лікарем
Ми розрахували відсоток людей від населення районів і міст України, які підписали декларації у лікарнях на своїй території проживання. Середній показник тих, хто підписав декларації, становить 70% по країні. Найменша кількість підписаних декларацій — на півдні країни, в середньому — 65%. На графіку нижче ви можете вибрати область і досліджувати статистику по регіонах самостійно.
</p>   
    ...
    <p class="text">На одного лікаря в приватних клініках припадає в середньому 500 пацієнтів, тоді як у комунальних — більше тисячі. У цього може бути кілька пояснень. Перше: люди частіше звертаються в ті лікарні, в які звикли ходити до реформи. Друге: в приватних медзакладах лікарі менше залежать від грошей НСЗУ, бо паралельно надають платні послуги.
</p> 
  </div>
