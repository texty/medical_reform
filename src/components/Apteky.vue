  ...
  <div>
    ...
    >
      ...
      <p
        class="text"
      >
  Ми розробили інструмент, який дозволить кожному українцю знайти в радіусі семи кілометрів від своєї лікарні найближчу аптеку, що працює за урядовою програмою “Доступні ліки”. Згідно з цією програмою, пацієнт, який уклав декларацію з сімейним лікарем, педіатром чи терапевтом, може за його рецептом отримувати ліки, частково або повністю оплачені державою. Вартість ліків оплачується Національною службою здоров’я України коштом платників податків. За даними НСЗУ, станом на 1 листопада до програми “Доступні ліки” приєдналися вже понад 7700 аптек. Це приблизно третина від їх загальної кількості в Україні. 
</p>
      <p
        class="text" >
Однак не в кожному населеному пункті є аптека, що працює за програмою — зокрема, якщо йдеться про сільську місцевість. У таких випадках користувач за допомогою інтерактивної карти може знайти необхідну аптеку не далі семи кілометрів від лікарні або амбулаторії, де він обслуговується. 
</p>
      <p
        class="text" >
На противагу, у великих містах біля медзакладу може бути багато аптек, але серед них за програмою “Доступні ліки” працюватиме лише частина. Інструмент допоможе пацієнтам визначити, які саме з наявних аптек долучені до програми. Як показав наш аналіз, 66% місць, де надається первинна медична допомога (ПМД), мають у радіусі 7 кілометрів аптеку, приєднану до програми “Доступні ліки”.
</p>

      <p
        class="text" >
Скористатися перевагами інструменту можуть не тільки пацієнти, але й представники аптечного бізнесу та місцевої влади.
</p>

      <p
        class="text" >
Для бізнесу становитиме інтерес насамперед співвідношення кількості пацієнтів та аптек у певній місцевості. В Україні наразі нараховується 28,6 мільйонів пацієнтів, які уклали декларації з сімейними лікарями. Вони обслуговуються в медичних закладах, які підписали договори з Національною службою здоров’я України — за даними установи, це вже встигли зробити понад 1400 закладів первинної медичної допомоги (ПМД) та більш ніж 6300 амбулаторій. 
</p>

      <p
        class="text" >
Інструмент інформує про кількість пацієнтів з деклараціями для кожного з таких закладів. Водночас він показує концентрацію аптек у населених пунктах та довкола медзакладів. І, на додачу, можна перевірити суму компенсацій від НСЗУ для тієї чи іншої аптечної мережі за медпрепарати, надані пацієнтам за програмою “Доступні ліки”. Враховуючи всі ці дані, власники аптечних мереж можуть прораховувати передумови для розширення бізнесу: інструмент допоможе їм визначити, в яких місцевостях бракує аптек, а отже, де попит на ліки може бути вищим від пропозиції. 
</p>
...
Окрему можливість інструмент створює для місцевої влади, яка опікується комунальними аптеками. Такі аптеки не завжди мають змогу приєднатися до програми “Доступні ліки” — зокрема, через нестачу комп’ютерної техніки. Місцева влада, враховуючи потребу мешканців громади у безоплатних ліках, може допомагати комунальним аптекам комп’ютеризуватися та долучитися до програми.
      ...
      <p
        class="text" >
У вікнах пошуку над таблицею вводьте назву населеного пункту чи регіону, який вас цікавить. Інші фільтри для пошуку — назви аптек, а також вулиці, на яких вони розташовані. Таблиця автоматично оновлюється й підкаже вам найбільш відповідні варіанти. Якщо вам необхідна детальніша інформація про аптеки, лікарні та амбулаторії, ви можете перейти до інтерактивної карти під таблицею. По кожній аптеці вказується назва, адреса, належність до аптечної мережі та сума коштів, компенсованих державою цій мережі за програмою “Доступні ліки”. По кожній лікарні чи амбулаторії вказується назва, адреса та кількість пацієнтів, що підписали там декларації з лікарями.
</p>
