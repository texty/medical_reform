...
Не в кожному населеному пункті є така аптека — наприклад, якщо йдеться про маленькі населені пункти. Інструмент дозволить користувачу знайти відповідний аптечний заклад у розташованих поблизу містах або селах. 
      ...
      <p
        class="text" >
У великих містах ситуація буває протилежною. Навколо лікарні може бути багато аптек, але далеко не кожна з них долучена до програми “Доступні ліки”. Наш інструмент дозволить користувачу швидко знайти потрібну аптеку — для цього потрібен лише доступ до інтернету. Також цей інструмент корисний для місцевої влади і бізнесу, адже показує кількість пацієнтів у лікарнях, розташування та концентрацію аптек, суми компенсацій від держави за надані пацієнтам ліки. Таким чином, власники аптечних мереж можуть побачити можливості для розширення бізнесу, аби задовольнити попит на медичні препарати. Що стосується комунальних аптек, то місцева влада може допомогти їм комп’ютеризуватися, щоб долучитися до програми «Доступні ліки».
</p>
